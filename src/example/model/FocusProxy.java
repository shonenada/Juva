...
public class FocusProxy extends ModelProxy{
    ...
    public Focus getByIDs(String src_id, String dst_id) throws Throwable{
    ...
    public ArrayList getFocusList(String uid, String hidden) throws Throwable{
    ...
    public ArrayList getFansList(String uid) throws Throwable{
        UserProxy userProxy = new UserProxy();
        userProxy.setDatabase(this.db);
